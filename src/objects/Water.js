...
import * as THREE from '../constants.js';

/**
 * @author jbouny / https://github.com/jbouny
 *
 * Work based on :
 * @author Slayvin / http://slayvin.net : Flat mirror for js
...
function Water ( geometry, options ) {
	...
	if ( ! (Math.log(textureWidth)/Math.log(2)) % 1 === 0 || ! (Math.log(textureHeight)/Math.log(2)) % 1 === 0 ) {
